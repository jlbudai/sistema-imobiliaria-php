...
<html class="no-js" lang="pt-br">
	...
	<div class="row">
		<div class="twelve columns">
			<?php
			echo form_open('admin/cadastrar_nova_pagina');
				...
				echo form_input(array('name' => 'subtitulo'), set_value('subtitulo'));
				echo form_textarea(array('name' => 'conteudo'),  set_value('conteudo'), 'placeholder="conteúdo"');
				echo '<br/><br/>';
