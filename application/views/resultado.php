					...
					<?php 
							if ($imoveis):
								...
								foreach ($imoveis as $imovel) :
									...
									$this -> table -> add_row('<img src="'.$capa.'" /><img src="'.$status.'" style="position: absolute; left: 26px; height:80px;" />', $imovel -> CodUnico, $imovel -> tipo, $imovel -> negocio, number_format($imovel -> valor, 2, ",", "."), $imovel -> cidade, '<a href="'.base_url().'imoveis/detalhe-imovel/'.$imovel->CodUnico.'" class="button tiny right colibri">+ DETALHES</a>');
								endforeach;
								echo $this -> table -> generate();
								echo !empty($paginacao) ? $paginacao : '';
								
							else :
								echo "Não foi encontrado nenhum imóvel com esta descrição. Por Favor, refaça sua busca.";
							endif;					
					 ?>	
