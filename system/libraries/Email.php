...
class CI_Email {
	...
	var	$smtp_host		= "smtp.colibri.imb.br";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "site@colibri.imb.br";		// SMTP Username
	var	$smtp_pass		= "col16SIT";		// SMTP Password
	var	$smtp_port		= "587";	// SMTP Port
	var	$smtp_timeout	= 60;		// SMTP Timeout in seconds
	var	$smtp_crypto	= "";		// SMTP Encryption. Can be null, tls or ssl.
	var	$wordwrap		= TRUE;		// TRUE/FALSE  Turns word-wrap on/off
	var	$wrapchars		= "76";		// Number of characters to wrap at.
	var	$mailtype		= "text/html";	// text/html  Defines email formatting
